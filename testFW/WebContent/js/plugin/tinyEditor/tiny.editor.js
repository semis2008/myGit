...
TINY.editor = function() {
	...
	c['image'] = [20, 'Insert Image', 'i', 'insertimage', '请输入图片的 URL:', 'http://'];
	c['hr'] = [21, 'Insert Horizontal Rule', 'a', '插入分割线'];
	c['link'] = [22, 'Insert Hyperlink', 'i', 'createlink', '输入超链接 URL:', 'http://'];
	c['unlink'] = [23, 'Remove Hyperlink', 'a', '清除超链接'];
	c['unformat'] = [24, 'Remove Formatting', 'a', '清除格式'];
